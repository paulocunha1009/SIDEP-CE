-- SIDEP-CE - Diagnostico de acesso do aluno
-- Avaliacao: INF26-D-A498LH
-- Data: 02/08/2026
--
...
with alvo as (
  select upper(trim('INF26-D-A498LH')) as codigo
),
avaliacao as (
  select a.*
...
select sidep_obter_avaliacao_publica('INF26-D-A498LH', 'Aluno Teste Piloto') as retorno_rpc_aluno;
